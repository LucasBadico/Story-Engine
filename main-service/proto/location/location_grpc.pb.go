...
const (
	...
	LocationService_GetChildren_FullMethodName    = "/location.LocationService/GetChildren"
	LocationService_GetAncestors_FullMethodName   = "/location.LocationService/GetAncestors"
	LocationService_GetDescendants_FullMethodName = "/location.LocationService/GetDescendants"
	LocationService_MoveLocation_FullMethodName   = "/location.LocationService/MoveLocation"
)
...
type LocationServiceClient interface {
	...
	MoveLocation(ctx context.Context, in *MoveLocationRequest, opts ...grpc.CallOption) (*MoveLocationResponse, error)
}
...
func (c *locationServiceClient) ListLocations(ctx context.Context, in *ListLocationsRequest, opts ...grpc.CallOption) (*ListLocationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, LocationService_ListLocations_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *locationServiceClient) GetChildren(ctx context.Context, in *GetChildrenRequest, opts ...grpc.CallOption) (*GetChildrenResponse, error) {
	out := new(GetChildrenResponse)
	err := c.cc.Invoke(ctx, LocationService_GetChildren_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *locationServiceClient) GetAncestors(ctx context.Context, in *GetAncestorsRequest, opts ...grpc.CallOption) (*GetAncestorsResponse, error) {
	out := new(GetAncestorsResponse)
	err := c.cc.Invoke(ctx, LocationService_GetAncestors_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *locationServiceClient) GetDescendants(ctx context.Context, in *GetDescendantsRequest, opts ...grpc.CallOption) (*GetDescendantsResponse, error) {
	out := new(GetDescendantsResponse)
	err := c.cc.Invoke(ctx, LocationService_GetDescendants_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *locationServiceClient) MoveLocation(ctx context.Context, in *MoveLocationRequest, opts ...grpc.CallOption) (*MoveLocationResponse, error) {
	out := new(MoveLocationResponse)
	err := c.cc.Invoke(ctx, LocationService_MoveLocation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LocationServiceServer interface {
	...
	MoveLocation(context.Context, *MoveLocationRequest) (*MoveLocationResponse, error)
...
func (UnimplementedLocationServiceServer) GetChildren(context.Context, *GetChildrenRequest) (*GetChildrenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetChildren not implemented")
}
func (UnimplementedLocationServiceServer) GetAncestors(context.Context, *GetAncestorsRequest) (*GetAncestorsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAncestors not implemented")
}
func (UnimplementedLocationServiceServer) GetDescendants(context.Context, *GetDescendantsRequest) (*GetDescendantsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDescendants not implemented")
}
func (UnimplementedLocationServiceServer) MoveLocation(context.Context, *MoveLocationRequest) (*MoveLocationResponse, error) {
...
func _LocationService_GetChildren_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetChildrenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocationServiceServer).GetChildren(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LocationService_GetChildren_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).GetChildren(ctx, req.(*GetChildrenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _LocationService_GetAncestors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAncestorsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocationServiceServer).GetAncestors(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LocationService_GetAncestors_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).GetAncestors(ctx, req.(*GetAncestorsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _LocationService_GetDescendants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDescendantsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocationServiceServer).GetDescendants(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LocationService_GetDescendants_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).GetDescendants(ctx, req.(*GetDescendantsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _LocationService_MoveLocation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MoveLocationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LocationServiceServer).MoveLocation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LocationService_MoveLocation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LocationServiceServer).MoveLocation(ctx, req.(*MoveLocationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LocationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _LocationService_GetChildren_Handler,
		},
		{
			MethodName: "GetAncestors",
			Handler:    _LocationService_GetAncestors_Handler,
		},
		{
			MethodName: "GetDescendants",
			Handler:    _LocationService_GetDescendants_Handler,
		},
		{
			MethodName: "MoveLocation",
			Handler:    _LocationService_MoveLocation_Handler,
		},
	},
