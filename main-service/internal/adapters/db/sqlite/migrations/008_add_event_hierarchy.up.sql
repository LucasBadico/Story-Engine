...
CREATE INDEX IF NOT EXISTS idx_events_world_parent ON events(world_id, parent_id);
CREATE INDEX IF NOT EXISTS idx_events_hierarchy ON events(world_id, hierarchy_level);
CREATE INDEX IF NOT EXISTS idx_events_timeline_position ON events(world_id, timeline_position);
