...
type RPGClassRepository interface {
	...
	GetByID(ctx context.Context, id uuid.UUID) (*rpg.RPGClass, error)
	ListBySystem(ctx context.Context, rpgSystemID uuid.UUID) ([]*rpg.RPGClass, error)
	ListByParent(ctx context.Context, parentClassID uuid.UUID) ([]*rpg.RPGClass, error)
...
type RPGClassSkillRepository interface {
	...
	GetByID(ctx context.Context, id uuid.UUID) (*rpg.RPGClassSkill, error)
	GetByClassAndSkill(ctx context.Context, classID, skillID uuid.UUID) (*rpg.RPGClassSkill, error)
	ListByClass(ctx context.Context, classID uuid.UUID) ([]*rpg.RPGClassSkill, error)
