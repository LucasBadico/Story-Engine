...
type ArchetypeRepository interface {
	...
	GetByID(ctx context.Context, tenantID, id uuid.UUID) (*world.Archetype, error)
...
type ArchetypeTraitRepository interface {
	...
	GetByArchetype(ctx context.Context, tenantID, archetypeID uuid.UUID) ([]*world.ArchetypeTrait, error)
	GetByTrait(ctx context.Context, tenantID, traitID uuid.UUID) ([]*world.ArchetypeTrait, error)
	Delete(ctx context.Context, tenantID, archetypeID, traitID uuid.UUID) error
	DeleteByArchetype(ctx context.Context, tenantID, archetypeID uuid.UUID) error
}
