...
func TestEventHandler_Create(t *testing.T) {
	...
	handler := NewEventHandler(createEventUseCase, getEventUseCase, listEventsUseCase, updateEventUseCase, deleteEventUseCase, addReferenceUseCase, removeReferenceUseCase, getReferencesUseCase, updateReferenceUseCase, getChildrenUseCase, getAncestorsUseCase, getDescendantsUseCase, moveEventUseCase, setEpochUseCase, getEpochUseCase, getTimelineUseCase, getStatChangesUseCase, log)
